...
const build = process.env.BUILD || '/Users/kalp/projects/plantit/frontend/build';
...
app.listen(Number(process.env.PORT) || 3999, () => console.log('fix2 local stack on', build, process.env.PORT || 3999));
