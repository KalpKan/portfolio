...
const EV = '/Users/kalp/projects/plato-corpus/evidence/audit-2026-09-18';
...
(async () => {
  ...
  for (const w of [390, 360, 320, 1280]) {
    ...
    const t0 = Date.now();
    await Promise.all([page.waitForURL('**/review', { timeout: 60000 }), page.click('button[type=submit]:has-text("Generate Calendar")')]);
