...
| Case-study pages serve | `for s in unpark rc-car flashcards yash-birthday-pcb eeg; do curl -s -o /dev/null -w "$s %{http_code}\n" https://kalpkan.com/projects/$s; done` | `200` for each; `curl -s https://kalpkan.com/projects/classmyschedule \| grep -c "coming soon"` → `1` while H9 is open | ✅ 2026-09-18 (T4.1) |
