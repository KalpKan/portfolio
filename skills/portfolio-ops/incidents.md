...
- **Root cause:** as the previous entry: 100 deployments per rolling day for the whole Hobby team, burned in under four hours by per-commit auto-deploys, mostly docs-only pushes to the hub.
