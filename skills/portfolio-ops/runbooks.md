...
| Deploy a browser-ML app (MediaPipe) to Vercel | Written and executed 2026-09-18 (T3.1, pushups: `KalpKan/pushup-tracker-web` → project `pushups`, `https://pushups.kalpkan.com`); FIX r2 2026-09-19 added the versioned-model-URL rule, classifier augmentation and the hints-never-cost-a-rep rule |
