...
- `repo` may be `null` for work that is not on GitHub (today: flashcards, yash-birthday-pcb, eeg; emotes gained `KalpKan/emote-detector-web` in T3.2). The card then shows no repo link.
